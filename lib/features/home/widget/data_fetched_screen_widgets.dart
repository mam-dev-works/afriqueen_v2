...
// List Page with profile cards grid
//-----------------------Profile Cards Grid----------------------------
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Container(
                height: 228.h, // Further reduced to 150.h
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: item.photos.isNotEmpty
                          ? Material(
                              // for setting the elevation of the card to 0 of the list pages
                              elevation: 0,
                              child: ClipRRect(
                                // borderRadius: BorderRadius.only(
                                //   topLeft:
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            child: Icon(
              ...
              color: isLiked ? AppColors.red : AppColors.darkGrey,
              size: 15.r,
            ),
          ),
        );
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            child: Icon(
              ...
              color: isFavorited ? AppColors.red : AppColors.darkGrey,
              size: 15.r,
            ),
          ),
        );
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            child: Icon(
              ...
              color: isArchived ? AppColors.red : AppColors.darkGrey,
              size: 15.r,
            ),
          ),
        );
